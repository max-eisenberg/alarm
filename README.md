...
was you all along? touch id lets the laptop know the call is coming from inside the house.
...
done! the first run opens the one permission you need. turn on your terminal under **input monitoring**, quit and reopen Terminal, then run `./alarm` again.
...
notes and security limitations are in [TECHNICAL.md](./TECHNICAL.md).
